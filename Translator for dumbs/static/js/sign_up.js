...
const showPassword_2=document.querySelector("#show-password_2");
const passwordField_2=document.querySelector("#password_2");

showPassword_2.addEventListener("click",()=>{
    if(passwordField_2.type==="password"){
        passwordField_2.type="text";
        showPassword_2.classList.replace("fa-eye-slash","fa-eye");
    }
    else{
        passwordField_2.type="password";
        showPassword_2.classList.replace("fa-eye","fa-eye-slash");
    }
});*/
...
const usernameInput = document.querySelector('#username_2');
...
function isFormValid(){
    const inputContainers = form.querySelectorAll('.input-box_2');
    let result = true;
